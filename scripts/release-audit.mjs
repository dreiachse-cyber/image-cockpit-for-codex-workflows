...
function checkWorkflowIds() {
  ...
  [
    ...
    "image-download-panel",
    "Image Editing should place the image download card under the preview workspace",
    "Initial workspace should place the image download card under the preview workspace",
    "imageDownloadPanelComplete",
    "downloadSelectedImageAnimation",
    "Image Editing should expose the animated GIF download action",
    "Image Editing should expose the animated WebP download action",
    "PNG",
    "policy_or_safety",
    "Generation failed",
    "生成できませんでした",
    ...
    "Animation Preset Examples trigger should sit directly below the preset buttons",
    "Pick an animated sample",
    "Use Preset",
    "animation-preset-example-trigger",
    "animation-preset-modal",
    "animation-sample-sprite",
    "Animation Preset Examples should show 9 animated sprite samples",
    "Victory Cheer",
    "Animation preset loaded",
    "preExerciseButtonChecks",
    "3. Generate",
    "4. Download",
    "downloadPanelInWorkspace",
    "downloadPanelInSource",
    "should not show stale download preview images before a selected animation result exists",
    "Animated GIF",
    "Animated WebP",
    "Sprite Sheet",
    "hatch-pet locks the atlas",
