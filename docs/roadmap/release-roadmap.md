...
1. 画像生成: Codex Handoff job作成とLocal Inbox取り込みを自然につなげる
2. 画像編集: 注釈 / 編集メモ / 選択画像がjobに入ることを分かりやすくする
3. スプライトシート生成: grid splitの最短導線を分かりやすくする
4. スプライトシート編集: timeline、anchor、透明化、exportの最短導線を分かりやすくする
5. Browser QAで日本語 / Englishのヘッダー、Guided Start、4大ワークフローの入口を確認する
6. ご主人レビュー用に「見る順番」をfinal reportへ短くまとめる
