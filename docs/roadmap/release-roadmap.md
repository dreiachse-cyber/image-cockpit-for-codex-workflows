...
1. 4大ワークフローそれぞれの「入口、主操作、完了状態」を画面内で分かりやすくする
2. 画像生成: Codex Handoff job作成とLocal Inbox取り込みを自然につなげる
3. 画像編集: 注釈 / 編集メモ / 選択画像がjobに入ることを分かりやすくする
4. スプライトシート生成: grid splitの最短導線を分かりやすくする
5. スプライトシート編集: timeline、anchor、透明化、exportの最短導線を分かりやすくする
6. Browser QAで日本語 / Englishのヘッダー、Guided Start、4大ワークフローの入口を確認する
7. ご主人レビュー用に「見る順番」をfinal reportへ短くまとめる
