...
- Preset id: `skill-release`
- Current sample: `public/samples/skill-release-sheet.png`
- QA folder: `docs/qa/official-skill-release/`
- Source job / evidence id: `codex-job-2026-06-25T23-05-13-732Z`
- Current score: 95 / 100
- Decision: needs-retake

## Uplift Prompt Contract

skill release animation with ready pose, focus, energy gathers near the hand or staff, compact release burst, peak effect, recoil or follow-through, settle, ready pose, no arrows, bullets, guns, bows, or thrown weapons

Frame plan: 1 ready, 2 focus, 3 energy compresses, 4 release burst, 5 peak effect, 6 recoil/follow-through, 7 settle, 8 ready.
